...
export default function Checkout() {
    ...
    const handleCheckout = async () => {
        try {
            const response = await axios.post('https://staging.link2extreme.com/api/booking/cart/1/checkout', formData);
        ...
        <main id="home4">
            ...
            <div className="checkout-cart">
                <div className="checkout-raduis">
                    ...
                    <div className="form-container">
                        <div className="form-row">
                            ...
                            <input className="form-input" type="text" id="surname" name="surname" value={formData.surname} onChange={handleChange} />
                        </div>
                        <div className="form-row">
                            <label htmlFor="email">Email:</label>
                            <input className="form-input" type="email" id="email" name="email" value={formData.email} onChange={handleChange} />
                            <label htmlFor="mobile">Mobile:</label>
                            <input className="form-input" type="text" id="mobile" name="mobile" value={formData.mobile} onChange={handleChange} />
                        </div>
                    </div>
                </div>
                <div className="flex-card">
                    ...
                    <button className="btn-cart" onClick={handleCheckout}>Continue to Payment</button>
                </div>
            </div>
        </main>
    );
